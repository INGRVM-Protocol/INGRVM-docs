# INGRVM $DOPA Grant Program
*Phase 8: The Global Neural Fabric Expansion*

## **Overview**
The INGRVM Mesh is built by many brains. To accelerate the growth of our decentralized intelligence, we are launching the **$DOPA Grant Program**. This program rewards developers who create, optimize, and share high-efficiency neuromorphic "ingrvms" (skills) on the INGRVM Marketplace.

---

## **Grant Tiers**

### **Tier 1: Neural Seeds (500 - 2,000 $DOPA)**
...
### **Tier 2: Efficiency Hardening (2,000 - 10,000 $DOPA)**
...
### **Tier 3: Core Infrastructure (10,000+ $DOPA)**
...
1. **Build & Package:** Use `ingrvm_packager.py` to bundle your model and metadata.
...
4. **Propose:** Create a DAO proposal via `governance_dao.py` with the memo "GRANT_REQUEST: [INGRVMID]".
5. **Vote:** If the mesh community (weighted by reputation) accepts the proposal, the $DOPA is automatically minted to your node balance.

---

## **The Rule of Sovereignty**
All granted skills must be open-source and follow the **Distributed Authority Protocol (DAP)**. Once a grant is accepted, the skill becomes a public asset of the INGRVM neural fabric.
